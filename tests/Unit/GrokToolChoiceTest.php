 ...
 */
class TestableGrokToolChoiceProvider extends GrokProvider
{
...
describe('GrokProvider tool choice', function () {
    beforeEach(function () {
        $this->provider = new TestableGrokToolChoiceProvider('test-api-key');
        $this->tools = [
